...
class WXBizMsgCryptTool
{
    ...
    {
        $pc = new WXPrpcrypt($this->encodingAesKey);
        ...
        $encryptMsg = \App\Models\XMLHandler::callBackWxThirdMessage($data);
    ...
    public function decryptMsg($msgSignature, $timestamp=null, $nonce, $postData, &$msg)
    {
        ...
        if ($signature != $msgSignature) {
            return WXErrorCode::$ValidateSignatureError;
        }
